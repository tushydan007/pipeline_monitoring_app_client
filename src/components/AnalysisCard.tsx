...
//               {summary.coordinates.lat.toFixed(6)},{" "}
//               {summary.coordinates.lon.toFixed(6)}
//             </span>
//           </div>
//         )}
...
//                 <div
//                   key={idx}
//                   className="flex items-center gap-2 px-3 py-1.5 rounded-md border-2 bg-card hover:bg-muted/50 transition-colors"
//                   style={{ borderColor: legend.color }}
//                 >
//                   <div
...
//         {analysis.analysis_type === "object_identification" &&
//           summary.specific_data?.objects_identified && (
//             <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border-l-4 border-blue-500 space-y-2">
//               <p className="text-sm font-semibold text-blue-700 dark:text-blue-300">
//                 Objects Identified: {summary.specific_data.total_objects}
//               </p>
//               <div className="grid grid-cols-2 gap-2 text-xs">
