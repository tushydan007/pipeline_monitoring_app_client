...
export interface PipelineEncroachmentResult {
  detected: boolean;
  date: string;
...
export interface GroupedAnalysisResults {
  oil_spill_detection: OilSpillDetectionResult | null;
  pipeline_encroachment: PipelineEncroachmentResult | null;
  object_detection: ObjectDetectionResult | null;
}
...
export interface SatelliteImage {
  ...
  grouped_analysis_results?: GroupedAnalysisResults;
}
